...
import bikeRental from "./../assets/projects-ss/bike-rental.png";
import spaceTraveler from "./../assets/projects-ss/space-travelers.png";
import todoList from "./../assets/projects-ss/todo-list.png";
...
const projectsData: project[] = [
  {
    ...
    techUsed: [
      'React', 'Redux', 'HTML', 'CSS', 'API', 'Ruby on Rails', 'JavaScript'
    ],
    cardImg: bikeRental,
  ...
  },
  {
    ...
    techUsed: [
      'JavaScript', 'Jest', 'Webpack', 'CSS', 'HTML'
    ],
    cardImg: pokemon,
  ...
  },
  {
    ...
    techUsed: [
      'React', 'Redux', 'JavaScript', 'CSS', 'HTML', 'Jest'
    ],
    cardImg: spaceTraveler,
  ...
  },
  {
    ...
    techUsed: [
      'Redux', 'React', 'JavaScript', 'API', 'HTML', 'CSS'
    ],
    cardImg: weather,
